...
**
** Created: Thu Jan 26 17:20:22 2012
...
const QMetaObject ComportementSelector::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ComportementSelector,
      qt_meta_data_ComportementSelector, 0 }
};
...
int ComportementSelector::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: EmitSemiSitueSelected((*reinterpret_cast< SemieSitue*(*)>(_a[1]))); break;
        case 1: SlotSemiSitueSelected((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: Maj(); break;
        default: ;
        }
        _id -= 3;
