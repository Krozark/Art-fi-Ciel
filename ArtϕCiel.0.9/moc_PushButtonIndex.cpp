...
static const char qt_meta_stringdata_QPushButtonIndex[] = {
    "QPushButtonIndex\0\0index\0EmitIndex(int)\0"
    "EmitRemove(int)\0slotClicked()\0"
...
const QMetaObject &QPushButtonIndex::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *QPushButtonIndex::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *QPushButtonIndex::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QPushButtonIndex))
        return static_cast<void*>(const_cast< QPushButtonIndex*>(this));
    return QPushButton::qt_metacast(_clname);
}

int QPushButtonIndex::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void QPushButtonIndex::EmitIndex(int _t1)
{
...
// SIGNAL 1
void QPushButtonIndex::EmitRemove(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
